...
_note={'C':262,'CSharp':277,'D':294,'Eb':311,'E':330,'F':349,'FSharp':370,'G':392,
...
class music:
 def __init__(self, num):
  self.pwm=PWM(Pin(num))

 def tone(self, feq, duration):
  self.pwm.freq(feq)            
  self.pwm.duty(512)
  time.sleep_ms(duration)
  self.pwm.deinit()

 def play_melody(self, strA, timeB):
